...
//     document.dir = currentLang === "ar" ? "rtl" : "ltr"; // Handle RTL globally

//     // Simulate loading time (e.g., waiting for translations, data, etc.)
//     setTimeout(() => {
//       setIsLoading(false); // Once loading is complete, set to false
...
//   const isRTL = i18n.language === LOCALES.ARABIC;
