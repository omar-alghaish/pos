...
import "swiper/css"; // Import the default Swiper styles
import "swiper/css/navigation"; // Optional, for navigation arrows
import "swiper/css/pagination"; // Optional, for pagination bullets
import "swiper/css/scrollbar"; // Optional, for draggable scrollbar

// Optionally import additional modules
import { Navigation, Pagination, Scrollbar, A11y } from "swiper/modules";
import Search from "../../components/common/searchBar/Index";
